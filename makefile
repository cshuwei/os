...
$(BUILD_DIR)/keyboard.o:device/keyboard.c device/keyboard.c  kernel/global.h lib/string.h kernel/interrupt.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/ioqueue.o: device/ioqueue.c device/ioqueue.h  kernel/global.h lib/string.h kernel/interrupt.h  lib/stdint.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/tss.o: userprog/tss.c userprog/tss.h  kernel/global.h lib/string.h  lib/stdint.h lib/kernel/print.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/process.o:userprog/process.c userprog/process.h kernel/global.h lib/string.h lib/stdint.h lib/kernel/print.h kernel/interrupt.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/ide.o: device/ide.c device/ide.h lib/stdint.h thread/sync.h lib/kernel/list.h kernel/global.h thread/thread.h lib/kernel/bitmap.h kernel/memory.h \
					lib/kernel/io.h lib/stdio.h lib/stdint.h lib/kernel/stdio-kernel.h kernel/interrupt.h kernel/debug.h device/console.h device/timer.h lib/string.h
	$(CC) $(CFLAGS) $< -o $@
